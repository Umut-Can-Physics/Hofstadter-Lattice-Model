...
function SingleParticleModel_2(Nx::Int, Ny::Int, α::Float64 ,periodicity::Bool, gauge::String)
    ...
    neig = neighbors_2(Nx, Ny, periodicity)
    coordinates = square_lattice_2(Nx, Ny)[2]
